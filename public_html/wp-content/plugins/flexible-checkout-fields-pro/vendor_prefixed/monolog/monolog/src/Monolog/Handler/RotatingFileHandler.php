 ...
 */
class RotatingFileHandler extends \FCFProVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \FCFProVendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \FCFProVendor\Monolog\Utils::canonicalizePath($filename);
