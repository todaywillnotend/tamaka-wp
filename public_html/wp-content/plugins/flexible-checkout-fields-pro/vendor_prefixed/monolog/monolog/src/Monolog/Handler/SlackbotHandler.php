 ...
 */
class SlackbotHandler extends \FCFProVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \FCFProVendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
