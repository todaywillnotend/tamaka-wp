 ...
 */
class IntrospectionProcessor implements \FCFProVendor\Monolog\Processor\ProcessorInterface
{
    private $level;
    private $skipClassesPartials;
    private $skipStackFramesCount;
    private $skipFunctions = array('call_user_func', 'call_user_func_array');
    public function __construct($level = \FCFProVendor\Monolog\Logger::DEBUG, array $skipClassesPartials = array(), $skipStackFramesCount = 0)
    {
        $this->level = \FCFProVendor\Monolog\Logger::toMonologLevel($level);
