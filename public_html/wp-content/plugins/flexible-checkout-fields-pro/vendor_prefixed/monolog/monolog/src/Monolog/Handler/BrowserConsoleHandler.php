 ...
 */
class BrowserConsoleHandler extends \FCFProVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \FCFProVendor\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
