 ...
 */
class InfoActivationBuilder extends \FCFProVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
    ...
    public function build_plugin()
    {
        ...
        if ($this->plugin instanceof \FCFProVendor\WPDesk\PluginBuilder\Plugin\ActivationAware && $this->is_active) {
            $this->plugin->set_active();
        }
        return $this->plugin;
    }
    public function store_plugin(\FCFProVendor\WPDesk\PluginBuilder\Storage\PluginStorage $storage)
    {
