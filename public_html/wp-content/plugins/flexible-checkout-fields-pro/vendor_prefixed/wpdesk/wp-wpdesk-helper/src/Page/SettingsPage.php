...
namespace FCFProVendor\WPDesk\Helper\Page;
 ...
 */
class SettingsPage implements \FCFProVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    {
        \add_submenu_page('wpdesk-helper', \__('Settings', 'flexible-checkout-fields-pro'), \__('Settings', 'flexible-checkout-fields-pro'), 'manage_options', 'wpdesk-helper-settings', function () {
    ...
    private function handle_render_wpdesk_helper_settings()
    {
        ...
        <div class="wrap">
            <h1><?php 
        \_e('WP Desk Helper Settings', 'flexible-checkout-fields-pro');
        ?></h1>
