...
<form method="POST">
    <table class="wpdesk_helper_key_table">
        <tr>
            <td><?php 
\_e('Key:', 'flexible-checkout-fields-pro');
?></td>
...
?> /></td>
        ...
        <tr>
            <td><?php 
\_e('Email:', 'flexible-checkout-fields-pro');
?></td>
...
if ($activation_status == 'Deactivated') {
    ...
    \_e('Activate', 'flexible-checkout-fields-pro');
    ?></button>
				<?php 
} else {
    ?>
                    <button class="wpdesk_helper_button button"><?php 
    \_e('Deactivate', 'flexible-checkout-fields-pro');
    ?></button>
				<?php 
}
?>
