...
namespace FCFProVendor\WPDesk\License\Changelog;

use ArrayObject;
use FCFProVendor\WPDesk\License\Changelog\Parser\Line;
/**
 * Can parse changelog.
 *
...
class Parser
{
    ...
    private function get_lines()
    {
        ...
        return \array_map(function ($line) {
            return new \FCFProVendor\WPDesk\License\Changelog\Parser\Line($line);
