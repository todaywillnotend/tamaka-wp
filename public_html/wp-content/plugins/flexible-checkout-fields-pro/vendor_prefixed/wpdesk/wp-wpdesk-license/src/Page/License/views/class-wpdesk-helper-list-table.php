...
class WPDesk_Helper_List_Table extends \WP_List_Table
{
    ...
    {
        echo \wpautop(\__('No WP Desk plugins found.', 'flexible-checkout-fields-pro'));
    }
    ...
    {
        $columns = ['product_name' => \__('Plugin', 'flexible-checkout-fields-pro'), 'product_status' => \__('Subscription Status', 'flexible-checkout-fields-pro'), 'product_license' => \__('Subscription Data', 'flexible-checkout-fields-pro')];
        return $columns;
    }
    ...
    {
        $status = \__('Deactivated', 'flexible-checkout-fields-pro');
        if ($item['activation_status'] == 'Activated') {
            $status = \__('Activated', 'flexible-checkout-fields-pro');
        }
        return $status;
    }
