...
<h2><?php 
echo \sprintf(\__('You are deactivating %s plugin.', 'flexible-checkout-fields-pro'), $plugin_name);
?></h2>
...
<div class="wpdesk_tracker_deactivate">
	<div class="body">
		...
		<div class="panel active" data-panel-id="reasons">
			<h4><strong><?php 
\_e(' If you have a moment, please let us know why you are deactivating plugin (anonymous feedback):', 'flexible-checkout-fields-pro');
?></strong></h4>
			<ul id="reasons-list">
                <li class="reason">
                    <label>
	            	<span>
                        ...
                        <span><?php 
\_e('The plugin suddenly stopped working', 'flexible-checkout-fields-pro');
?></span>
                    </label>
                </li>
                <li class="reason">
	            	...
	            	<span>
                        ...
                        <span><?php 
\_e('The plugin broke my site', 'flexible-checkout-fields-pro');
?></span>
                    </label>
                </li>
				<li class="reason has-input">
					<label>
						...
						<span><?php 
\_e('I found a better plugin', 'flexible-checkout-fields-pro');
?></span>
					</label>
					<div id="found_better_plugin" class="reason-input">
						<input type="text" name="better_plugin_name" placeholder="<?php 
\_e('What\'s the plugin\'s name?', 'flexible-checkout-fields-pro');
?>">
					</div>
				</li>
				<li class="reason">
	            	...
	            	<span>
						...
						<span><?php 
\_e('I only needed the plugin for a short period', 'flexible-checkout-fields-pro');
?></span>
					</label>
				</li>
				<li class="reason">
	            	...
	            	<span>
						...
						<span><?php 
\_e('I no longer need the plugin', 'flexible-checkout-fields-pro');
?></span>
					</label>
				</li>
				<li class="reason">
	            	...
	            	<span>
						...
						<span><?php 
\_e('It\'s a temporary deactivation. I\'m just debugging an issue.', 'flexible-checkout-fields-pro');
?></span>
					</label>
				</li>
				<li class="reason has-input">
	            	...
	            	<span>
						...
						<span><?php 
\_e('Other', 'flexible-checkout-fields-pro');
?></span>
					</label>
					<div id="other" class="reason-input">
						<input type="text" name="other" placeholder="<?php 
\_e('Kindly tell us the reason so we can improve', 'flexible-checkout-fields-pro');
?>">
					</div>
				</li>
			</ul>
...
\_e('Cancel', 'flexible-checkout-fields-pro');
?></a>
        <a href="#" class="button button-primary button-deactivate allow-deactivate"><?php 
\_e('Skip &amp; Deactivate', 'flexible-checkout-fields-pro');
?></a>
	</div>
</div>
...
\_e('Submit &amp; Deactivate', 'flexible-checkout-fields-pro');
?>' );
	})
