...
use WPDesk\FCF\Free\Field\Type\Wc\WcPostcodeType as DefaultWcPostcodeType;
 ...
 */
class WcPostcodeType extends DefaultWcPostcodeType implements TypeInterface {
		...
		return array_merge(
			...
			[
				LogicTab::TAB_NAME => [
					...
					LogicInfoWcOption::FIELD_NAME          => new LogicInfoWcOption(),
				],
			]
		);
	}
